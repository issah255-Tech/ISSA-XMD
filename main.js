...
const { tictactoeCommand, handleTicTacToeMove } = require('./loftcore/tictactoe');
...
const { handleMentionDetection, mentionToggleCommand, setMentionCommand } = require('./loftcore/mention');
const memeCommand = require('./loftcore/meme');
...
const jokeCommand = require('./loftcore/joke');
const quoteCommand = require('./loftcore/quote');
const factCommand = require('./loftcore/fact');
const weatherCommand = require('./loftcore/weather');
const newsCommand = require('./loftcore/news');
const kickCommand = require('./loftcore/kick');
const simageCommand = require('./loftcore/simage');
const attpCommand = require('./loftcore/attp');
const { startHangman, guessLetter } = require('./loftcore/hangman');
const { startTrivia, answerTrivia } = require('./loftcore/trivia');
const { complimentCommand } = require('./loftcore/compliment');
const { insultCommand } = require('./loftcore/insult');
const { eightBallCommand } = require('./loftcore/eightball');
const { lyricsCommand } = require('./loftcore/lyrics');
const { dareCommand } = require('./loftcore/dare');
const { truthCommand } = require('./loftcore/truth');
...
const { welcomeCommand, handleJoinEvent } = require('./loftcore/welcome');
const { goodbyeCommand, handleLeaveEvent } = require('./loftcore/goodbye');
const githubCommand = require('./loftcore/github');
const { handleAntiBadwordCommand, handleBadwordDetection } = require('./lib/antibadword');
const antibadwordCommand = require('./loftcore/antibadword');
const { handleChatbotCommand, handleChatbotResponse } = require('./loftcore/chatbot');
const takeCommand = require('./loftcore/take');
const { flirtCommand } = require('./loftcore/flirt');
const characterCommand = require('./loftcore/character');
const wastedCommand = require('./loftcore/wasted');
const shipCommand = require('./loftcore/ship');
const groupInfoCommand = require('./loftcore/groupinfo');
...
const { simpCommand } = require('./loftcore/simp');
const { stupidCommand } = require('./loftcore/stupid');
...
const songCommand = require('./loftcore/song');
...
const { handleSsCommand } = require('./loftcore/ss');
const { addCommandReaction, handleAreactCommand } = require('./lib/reactions');
const { goodnightCommand } = require('./loftcore/goodnight');
const { shayariCommand } = require('./loftcore/shayari');
const { rosedayCommand } = require('./loftcore/roseday');
...
const { miscCommand, handleHeart } = require('./loftcore/misc');
const { animeCommand } = require('./loftcore/anime');
const { piesCommand, piesAlias } = require('./loftcore/pies');
const stickercropCommand = require('./loftcore/stickercrop');
const updateCommand = require('./loftcore/update');
const removebgCommand = require('./loftcore/removebg');
const { reminiCommand } = require('./loftcore/remini');
...
const soraCommand = require('./loftcore/sora');
